...
ILI9488_T4::DiffBuffStatic<8000> diff1;
ILI9488_T4::DiffBuffStatic<8000> diff2;

// the internal framebuffer for the ILI9488_T4 driver (150KB) 
// in DMAMEM to save space in the lower (faster) partof RAM. 
DMAMEM uint16_t internal_fb[LX * LY];

// the screen driver object
ILI9488_T4::ILI9488Driver tft(PIN_CS, PIN_DC, PIN_SCK, PIN_MOSI, PIN_MISO, PIN_RESET, PIN_TOUCH_CS, PIN_TOUCH_IRQ);
