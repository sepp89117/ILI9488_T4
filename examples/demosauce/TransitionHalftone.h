...
public:
  ...
  void init(ILI9488Wrapper & tft);
	void restart(ILI9488Wrapper & tft, uint_fast16_t color );
...
void TransitionHalftone::init(ILI9488Wrapper & tft) {

}

void TransitionHalftone::restart(ILI9488Wrapper & tft, uint_fast16_t inColor ) {
...
void TransitionHalftone::perFrame(ILI9488Wrapper & tft, FrameParams frameParams ) {
