...
void TransitionScroll::init(ILI9488Wrapper & tft) {
	_pixels = (uint16_t*)malloc( sizeof(uint_fast16_t) * tft.width() );
}

void TransitionScroll::restart(ILI9488Wrapper & tft, uint_fast16_t inColor ) {
...
void TransitionScroll::perFrame(ILI9488Wrapper & tft, FrameParams frameParams ) {
