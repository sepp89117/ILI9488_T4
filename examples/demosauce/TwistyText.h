...
void TwistyText::init(ILI9488Wrapper & tft) {
...
void TwistyText::reset(ILI9488Wrapper & tft) {
...
void TwistyText::perFrame(ILI9488Wrapper & tft, FrameParams frameParams ) {
