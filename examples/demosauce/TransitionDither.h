...
void TransitionDither::init(ILI9488Wrapper & tft) {

}

void TransitionDither::restart(ILI9488Wrapper & tft, uint_fast16_t inColor ) {
...
void TransitionDither::perFrame(ILI9488Wrapper & tft, FrameParams frameParams ) {
