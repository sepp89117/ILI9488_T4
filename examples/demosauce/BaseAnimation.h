...
public:
	...
	virtual void reset(ILI9488Wrapper& tft);
...
void BaseAnimation::init(ILI9488Wrapper& tft) {
	// Extend me
}
...
void BaseAnimation::reset(ILI9488Wrapper& tft) {
	// Extend me
}
...
void BaseAnimation::perFrame(ILI9488Wrapper& tft, FrameParams frameParams ) {
	// Extend me
}
