...
/**
* Minimal wrapper for the ILI9488Driver class that implement the
* needed drawing primitives (line / circle / rectangle...). 
**/
class ILI9488Wrapper : public ILI9488_T4::ILI9488Driver
{

public:


    ILI9488Wrapper(uint8_t cs, uint8_t dc, uint8_t sclk, uint8_t mosi, uint8_t miso, uint8_t rst = 255, uint8_t touch_cs = 255, uint8_t touch_irq = 255) : ILI9488Driver(cs, dc, sclk, mosi, miso, rst, touch_cs, touch_irq)
        {
        }
