...
void TransitionSquares::init(ILI9488Wrapper & tft) {

}

void TransitionSquares::restart(ILI9488Wrapper & tft, uint_fast16_t inColor ) {
...
void TransitionSquares::perFrame(ILI9488Wrapper & tft, FrameParams frameParams ) {
