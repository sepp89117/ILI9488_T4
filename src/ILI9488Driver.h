...
*
* (1) KurtE's highly optimized library for ILI9488: https://github.com/KurtE/ILI9488_t3n
...
#ifndef _ILI9488_T4_ILI9488Driver_H_
#define _ILI9488_T4_ILI9488Driver_H_
...
#define ILI9488_T4_DEFAULT_SPICLOCK 30e6     // default SPI write speed, some display can work up to 80Mhz...
#define ILI9488_T4_DEFAULT_SPICLOCK_READ 4e6 // default SPI read speed (much slower then write speed)

#define ILI9488_T4_DEFAULT_VSYNC_SPACING 2       // vsync on with framerate = refreshrate/2 = 45FPS.
#define ILI9488_T4_DEFAULT_DIFF_GAP 6            // default gap for diffs (typ. between 4 and 50)
#define ILI9488_T4_DEFAULT_LATE_START_RATIO 0.3f // default "proportion" of the frame admissible for late frame start when using vsync.

#define ILI9488_T4_TRANSACTION_DURATION 3            // number of pixels that could be uploaded during a typical CASET/PASET/RAWR sequence.
#define ILI9488_T4_RETRY_INIT 5                      // number of times we try initialization in begin() before returning an error.
#define ILI9488_T4_TFTWIDTH 320                      // screen dimension x (in default orientation 0)
#define ILI9488_T4_TFTHEIGHT 480                     // screen dimension y (in default orientation 0)
#define ILI9488_T4_NB_SCANLINES ILI9488_T4_TFTHEIGHT // scanlines are mapped to the screen height
#define ILI9488_T4_MIN_WAIT_TIME 300                 // minimum waiting time (in us) before drawing again when catching up with the scanline

#define ILI9488_T4_NB_PIXELS (ILI9488_T4_TFTWIDTH * ILI9488_T4_TFTHEIGHT) // total number of pixels

#define ILI9488_T4_MAX_VSYNC_SPACING 10           // maximum number of screen refresh between frames (for sync clock stability).
#define ILI9488_T4_IRQ_PRIORITY 128               // priority at which we run the irqs (dma and pit timer).
#define ILI9488_T4_MAX_DELAY_MICROSECONDS 1000000 // maximum waiting time (1 second)

#define ILI9488_T4_TOUCH_Z_THRESHOLD 400    // for touch
#define ILI9488_T4_TOUCH_Z_THRESHOLD_INT 75 // same as https://github.com/PaulStoffregen/XPT2046_Touchscreen/blob/master/XPT2046_Touchscreen.cpp
#define ILI9488_T4_TOUCH_MSEC_THRESHOLD 3   //

#define ILI9488_T4_SELFDIAG_OK 0xC0 // value returned by selfDiagStatus() if everything is OK.

    /** ILI9488 command codes */

#define ILI9488_T4_NOP 0x00
#define ILI9488_T4_SWRESET 0x01
#define ILI9488_T4_RDDID 0x04
#define ILI9488_T4_RDDST 0x09

#define ILI9488_T4_SLPIN 0x10
#define ILI9488_T4_SLPOUT 0x11
#define ILI9488_T4_PTLON 0x12
#define ILI9488_T4_NORON 0x13

#define ILI9488_T4_RDMODE 0x0A
#define ILI9488_T4_RDMADCTL 0x0B
#define ILI9488_T4_RDPIXFMT 0x0C
#define ILI9488_T4_RDIMGFMT 0x0D
#define ILI9488_T4_RDSGNMODE 0x0E
#define ILI9488_T4_RDSELFDIAG 0x0F

#define ILI9488_T4_INVOFF 0x20
#define ILI9488_T4_INVON 0x21
#define ILI9488_T4_GAMMASET 0x26
#define ILI9488_T4_DISPOFF 0x28
#define ILI9488_T4_DISPON 0x29

#define ILI9488_T4_CASET 0x2A
#define ILI9488_T4_PASET 0x2B
#define ILI9488_T4_RAMWR 0x2C
#define ILI9488_T4_RAMRD 0x2E

#define ILI9488_T4_PTLAR 0x30
#define ILI9488_T4_MADCTL 0x36
#define ILI9488_T4_VSCRSADD 0x37
#define ILI9488_T4_PIXFMT 0x3A

#define ILI9488_T4_FRMCTR1 0xB1
#define ILI9488_T4_FRMCTR2 0xB2
#define ILI9488_T4_FRMCTR3 0xB3
#define ILI9488_T4_INVCTR 0xB4
#define ILI9488_T4_DFUNCTR 0xB6

#define ILI9488_T4_PWCTR1 0xC0
#define ILI9488_T4_PWCTR2 0xC1
#define ILI9488_T4_PWCTR3 0xC2
#define ILI9488_T4_PWCTR4 0xC3
#define ILI9488_T4_PWCTR5 0xC4
#define ILI9488_T4_VMCTR1 0xC5
#define ILI9488_T4_VMCTR2 0xC7

#define ILI9488_T4_RDID1 0xDA
#define ILI9488_T4_RDID2 0xDB
#define ILI9488_T4_RDID3 0xDC
#define ILI9488_T4_RDID4 0xDD

#define ILI9488_T4_GMCTRP1 0xE0
#define ILI9488_T4_GMCTRN1 0xE1
#define ILI9488_T4_PWCTR6 0xFC

    /*************************************************************************************************************
* ILI9488 screen driver for Teensy 4/4.1.
*
...
****************************************************************************************************************/
    ...
    * --------------------------------------------------------------------------------------------
    **/
        ILI9488Driver(uint8_t cs, uint8_t dc, uint8_t sclk, uint8_t mosi, uint8_t miso, uint8_t rst = 255, uint8_t touch_cs = 255, uint8_t touch_irq = 255);
    ...
    **/
        bool begin(uint32_t spi_clock = ILI9488_T4_DEFAULT_SPICLOCK, uint32_t spi_clock_read = ILI9488_T4_DEFAULT_SPICLOCK_READ);

        /**
    * Query the value of the self-diagnostic register.
    * Should return ILI9488_T4_SELFDIAG_OK = 0xC0 if everything is fine.
    **/
        int selfDiagStatus();
    ...
    **/
        inline void setSpiClock(int spi_clock = ILI9488_T4_DEFAULT_SPICLOCK)
        {
    ...
    * Remark: calling this method reset the statistics.
    **/
        inline void setSpiClockRead(int spi_clock = ILI9488_T4_DEFAULT_SPICLOCK_READ)
        {
            waitUpdateAsyncComplete();
    ...
    *
    * This number must be between -1 and 10 = ILI9488_T4_MAX_VSYNC_SPACING.
    *
    ...
    * Remark: calling this method reset the statistics.
    **/
        void setVSyncSpacing(int vsync_spacing = ILI9488_T4_DEFAULT_VSYNC_SPACING)
        {
            waitUpdateAsyncComplete();
            _vsync_spacing = ILI9488Driver::_clip<int>((int)vsync_spacing, (int)-1, (int)ILI9488_T4_MAX_VSYNC_SPACING);
            statsReset();
            resync();
        }
    ...
    * Remark: calling this method reset the statistics.
    **/
        void setLateStartRatio(float ratio = ILI9488_T4_DEFAULT_LATE_START_RATIO)
        {
            waitUpdateAsyncComplete(); // no need to wait for sync.
            _late_start_ratio = ILI9488Driver::_clip<float>(ratio, 0.1f, 0.9f);
            statsReset();
            resync();
        }
    ...
    * Remark: calling this method reset the statistics.
    **/
        void setDiffGap(int gap = ILI9488_T4_DEFAULT_DIFF_GAP)
        {
            waitUpdateAsyncComplete();
            _diff_gap = ILI9488Driver::_clip<int>((int)gap, (int)1, (int)ILI9488_T4_NB_PIXELS);
            statsReset();
            resync();
        }
    ...
    **/
        ...
        {
            _compare_mask = (((uint16_t)(((0xFF >> bitskip_red) << bitskip_red) & 31)) << 11) | (((uint16_t)(((0xFF >> bitskip_green) << bitskip_green) & 63)) << 5) | ((uint16_t)(((0xFF >> bitskip_blue) << bitskip_blue) & 31));
    ...
    **/
        ...
        {
            while ((_dma_state != ILI9488_T4_DMA_IDLE))
                ;
        }
    ...
    **/
        inline bool asyncUpdateActive() const { return (_dma_state != ILI9488_T4_DMA_IDLE); }
    ...
    **/
        float statsRatioPixelPerFrame() const { return (((float)_statsvar_uploaded_pixels.avg()) / ILI9488_T4_NB_PIXELS); }
    ...
    **/
        ...
        {
            if ((!diffUpdateActive()) || (_statsvar_transactions.count() == 0))
                return 1.0f;
            return ((float)(ILI9488_T4_NB_PIXELS * 16)) / ((float)_spi_clock) * (1000000.0f / _statsvar_uploadtime.avg());
        }
    ...
    **/
        inline void setTouchThreshold(int Zthreshold = ILI9488_T4_TOUCH_Z_THRESHOLD)
        {
    ...
    ***********************************************************************************************************/
        ...
        using methodCB_t = void (ILI9488Driver::*)(void); // typedef to method callback.
        ...
        template <typename T>
        void _print(const T &v) const
        {
            if (_outputStream)
                _outputStream->print(v);
        }

        template <typename T>
        void _println(const T &v) const
        {
            if (_outputStream)
                _outputStream->println(v);
        }

        template <typename T1, typename T2>
        void _print(const T1 &u, const T2 &v) const
        {
            if (_outputStream)
                _outputStream->print(u, v);
        }

        template <typename T1, typename T2>
        void _println(const T1 &u, const T2 &v) const
        {
            if (_outputStream)
                _outputStream->println(u, v);
        }

        template <typename T1>
        void _printf(const char *str, const T1 &a) const
        {
            if (_outputStream)
                _outputStream->printf(str, a);
        }

        template <typename T1, typename T2>
        void _printf(const char *str, const T1 &a, const T2 &b) const
        {
            if (_outputStream)
                _outputStream->printf(str, a, b);
        }

        template <typename T1, typename T2, typename T3>
        void _printf(const char *str, const T1 &a, const T2 &b, const T3 &c) const
        {
            if (_outputStream)
                _outputStream->printf(str, a, b, c);
        }

        template <typename T1, typename T2, typename T3, typename T4>
        void _printf(const char *str, const T1 &a, const T2 &b, const T3 &c, const T4 &d) const
        {
            if (_outputStream)
                _outputStream->printf(str, a, b, c, d);
        }
    ...
    **/
        ...
        /** clip val to [min,max] */
        template <typename T>
        static T _clip(T val, T min, T max)
        {
            if (val < min)
                val = min;
            if (val > max)
    ...
    ***********************************************************************************************************/
        ...
        static ILI9488Driver *volatile _dmaObject[3]; // points back to this-> (for the corresponding spi bus)

        enum
        {
            ILI9488_T4_DMA_IDLE = 0,
            ILI9488_T4_DMA_ON = 2,
        };
        ...
        static void _dmaInterruptSPI0Diff()
        {
            if (_dmaObject[0])
            {
                _dmaObject[0]->_dmaInterruptDiff();
            }
        } // called when using spi 0
        static void _dmaInterruptSPI1Diff()
        {
            if (_dmaObject[1])
            {
                _dmaObject[1]->_dmaInterruptDiff();
            }
        } // called when using spi 1
        static void _dmaInterruptSPI2Diff()
        {
            if (_dmaObject[2])
            {
                _dmaObject[2]->_dmaInterruptDiff();
            }
        } // called when using spi 2
     ...
     **/
        ...
        {
            if ((uint32_t)ptr >= 0x20200000u)
                arm_dcache_flush((void *)ptr, len);
            asm("dsb");
        }
        ...
        void _write16BitColor(uint16_t color, bool last_pixel = false);
    ...
    * than ILI9488_T4_MAX_DELAY_MICROSECONDS
    **/
        void _delayMicro(uint32_t t)
        {
            if (t < ILI9488_T4_MAX_DELAY_MICROSECONDS)
                delayMicroseconds(t); // only allow delay of at most 0.1 second.
        }
    ...
    **/
        ...
        {
            return ((t * ILI9488_T4_NB_SCANLINES) / _period);
        }
    ...
    **/
        ...
        {
            return (nbscanline * _period) / ILI9488_T4_NB_SCANLINES;
        }

        /**
    * Convert a ratio in [0.0f, 1.0f] to a scanline in [|0, ILI9488_T4_NB_SCANLINES - 1|]
    **/
        int _ratioToScanline(float r) const __attribute__((always_inline))
        {
            int l = (int)(r * ILI9488_T4_NB_SCANLINES);
            l = ILI9488Driver::_clip((int)l, (int)0, (int)ILI9488_T4_NB_SCANLINES - 1);
            return l;
        }
    ...
    **/
        uint32_t _microToExitRange(int start, int end)
        {
            ...
            if ((delta < 0) || ((5 * delta) >= (4 * ILI9488_T4_NB_SCANLINES)))
                return 0; // invalid range (negative or too big).
            int v = _getScanLine(false);
            if ((v < start) || (v > end))
                return 0;                                                                   // no wait needed.
            return 1 + _microToReachScanLine(((end + 1) % ILI9488_T4_NB_SCANLINES), false); // make sur it is not 0.
        }
    ...
    **/
        uint32_t _microToReachScanLine(int scanline, bool sync) __attribute__((always_inline))
        {
            ...
            const uint32_t diff = (now <= scanline) ? (uint32_t)(scanline - now) : (uint32_t)(scanline - now + ILI9488_T4_NB_SCANLINES);
            return (diff * _period) / ILI9488_T4_NB_SCANLINES;
        }
    ...
    ***********************************************************************************************************/
        ...
        static ILI9488Driver *volatile _pitObj[4]; // point back to this->
        ...
        static void _pitcb0()
        {
            ...
            {
                _pitObj[0]->_it.end();
                _pitObj[0]->_istimer = false;
                ((_pitObj[0])->*(_pitObj[0]->_pitcb))();
            }
        } // forward to the timer method cb
        static void _pitcb1()
        {
            if (_pitObj[1])
            {
                _pitObj[1]->_it.end();
                _pitObj[1]->_istimer = false;
                ((_pitObj[1])->*(_pitObj[1]->_pitcb))();
            }
        } // forward to the timer method cb
        static void _pitcb2()
        {
            ...
            {
                _pitObj[2]->_it.end();
                _pitObj[2]->_istimer = false;
                ((_pitObj[2])->*(_pitObj[2]->_pitcb))();
            }
        } // forward to the timer method cb
        static void _pitcb3()
        {
            ...
            {
                _pitObj[3]->_it.end();
                _pitObj[3]->_istimer = false;
                ((_pitObj[3])->*(_pitObj[3]->_pitcb))();
            }
        } // forward to the timer method cb
        ...
        void _setTimerIn(uint32_t us, methodCB_t timercb) __attribute__((always_inline))
        {
            ...
            _pitcb = timercb;
            if ((us <= 1) || (us > ILI9488_T4_MAX_DELAY_MICROSECONDS))
            {
                us = 1;
            }                                                    // asap
            NVIC_SET_PRIORITY(IRQ_PIT, ILI9488_T4_IRQ_PRIORITY); // set priority directly for all pit timer (on teensy 4: priority is shared by all pit timer).
            _istimer = true;
            switch (_pitindex)
            {
            case 0:
            ...
            NVIC_SET_PRIORITY(IRQ_PIT, ILI9488_T4_IRQ_PRIORITY); // just in case...
        }
    ...
    ***********************************************************************************************************/
        ...
        {
            if (_csport)
                _directWriteHigh(_csport, _cspinmask); // drive CS high
...
#define ILI9488_T4_TCR_MASK (LPSPI_TCR_PCS(3) | LPSPI_TCR_FRAMESZ(31) | LPSPI_TCR_CONT | LPSPI_TCR_RXMSK)
    ...
    ***********************************************************************************************************/
        ...
        static ILI9488Driver *volatile _touchObjects[4]; // point back to this->

        static void _touch_int0()
        {
            if (_touchObjects[0])
            {
                _touchObjects[0]->_touch_int();
            }
        } // forward to the touch interrupt method cb
        static void _touch_int1()
        {
            if (_touchObjects[1])
            {
                _touchObjects[1]->_touch_int();
            }
        } // forward to the touch interrupt method cb
        static void _touch_int2()
        {
            if (_touchObjects[2])
            {
                _touchObjects[2]->_touch_int();
            }
        } // forward to the touch interrupt method cb
        static void _touch_int3()
        {
            if (_touchObjects[3])
            {
                _touchObjects[3]->_touch_int();
            }
        } // forward to the touch interrupt method cb
        ...
        {
            return ILI9488Driver::_clip<int>((int)roundf(ILI9488_T4_TFTWIDTH * ((float)(x - A)) / (B - A)), (int)0, (int)ILI9488_T4_TFTWIDTH - 1);
        }

        /** convert from raw value to y coord (in orientation 0) */
        inline int _mapTouchY(int y, int C, int D)
        {
            return ILI9488Driver::_clip<int>((int)roundf(ILI9488_T4_TFTHEIGHT * ((float)(y - C)) / (D - C)), (int)0, (int)ILI9488_T4_TFTHEIGHT - 1);
        }
